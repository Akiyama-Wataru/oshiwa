...
cluster_root="$(mktemp -d /private/tmp/oshiwa-oshis.XXXXXX)"
...
psql "${psql_args[@]}" \
  -f "${repository_root}/supabase/tests/oshis_rls.sql"

echo "oshi/media migration smoke and invariants: PASS"
